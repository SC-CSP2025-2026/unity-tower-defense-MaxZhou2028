...
public class TurretSpawner : MonoBehaviour
{
    ...
    void OnDisable()
    {
        Controller.InfoLabel.text = "Click Bulid to place a Turret";
    ...
    public void ListenToTilesIn(GameObject grid)
    {
        ...
        {
            tile.OnCursorClicked.AddListener(ShowInfo);
    ...
    public void SpawnTurret(TileController tileController)
    {
        ...
        {
            return;//don't spawn a turret if it's already occuiped
        }
        if (CanSpawn(tileController))
        {
            ...
            Controller.Gold -= 50;
            gameObject.SetActive(false); //disable our turrect spawner
        }
    }
    ...
    public void ShowInfo(TileController tileController)
    {
        ...
        {
            Controller.InfoLabel.text = "<color=red>Not Enought Gold/color";
        }
        else
        {
